  ...
  return (
    <div className="container">
                    ...
                    <div className="metrics-inner">
                      ...
                      <div className="metric-box twitter-impact">
                        ...
                        <div className="twitter-stats-column">
                          <div className="stat-row">
                            <span className="stat-dot-small posts" style={{ background: '#fff', boxShadow: '0 0 5px #fff' }}></span>
      ...
      <style jsx global>{`
        ...
        .value.positive { color: #4ade80; text-shadow: 0 0 5px rgba(74,222,128,0.5); }
        .value.negative { color: #ef4444; text-shadow: 0 0 5px rgba(239,68,68,0.5); }
        ...
        .stat-row.sub { opacity: 0.8; margin-top: -1px; }
        ...
        .channel-activity-row { display: flex; align-items: baseline; gap: 6px; margin-top: 4px; opacity: 0.9; }
        ...
        .server-stats-panel:hover .stat-item {
        ...
        .server-stats-panel:hover .stat-icon {
        ...
        .server-stats-panel:hover .stat-value {
        ...
        .modal-titles h2 { margin: 10px 0 5px; font-size: 2.2rem; color: #fff; text-shadow: 0 0 10px rgba(0,0,0,0.2); }
        .modal-titles p { margin: 0; color: rgba(255,255,255,0.95); font-size: 1rem; }
        ...
        .score-sub { display: block; color: rgba(255,255,255,0.95); font-size: 0.8rem; }
        .score-value { font-size: 2.5rem; font-weight: 700; color: #fff; text-shadow: 0 0 15px rgba(255,255,255,0.4); }
        ...
        .footer { text-align: center; padding: 40px 0; margin-top: 60px; border-top: 2px solid rgba(255,255,255,0.2); }
        
        .footer-links { display: flex; justify-content: center; align-items: center; gap: 15px; }
        
        .f-link { color: rgba(255,255,255,0.95); text-decoration: none; opacity: 0.95; transition: 0.2s; display: flex; align-items: center; gap: 8px; }
        .f-link:hover { opacity: 1; color: #fff; }
