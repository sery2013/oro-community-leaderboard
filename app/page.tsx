    ...
    <div className="container">
      ...
      <style jsx global>{`
        ...
        body {
          ...
          background: linear-gradient(-45deg, #FF8C00, #FFA500, #FFB347, #FF7F50);
        ...
        /* 2. Анимированный градиентный текст заголовка */
        .main-title {
          font-size: 2.2rem;
          font-weight: 900;
          letter-spacing: 5px;
        ...
        /* 3 & 4. Улучшенные карточки (Стеклянный эффект и анимация) */
        .contributor-card {
          cursor: pointer;
          display: flex;
