...
export default function Leaderboard() {
  ...
  const [lastSync, setLastSync] = useState<string>('SYNCHRONIZING...'); // Состояние для даты
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      // 🔥 Извлекаем дату последнего обновления из базы
      if (validData.length > 0 && validData[0].updated_at) {
        const date = new Date(validData[0].updated_at);
        ...
        setLastSync(formatted.toUpperCase());
      }
  ...
  return (
    <div className="container">
          ...
          <div className="branding-banner">
            <div className="branding-content">
              ...
              <div className="status-info">
                {/* Динамическая дата из Supabase */}
                <span className="update-badge">{lastSync}</span>
                  ...
                  <div className="card-metrics">
                    <div className="metrics-inner">
                      ...
                      <div className="metric-box total">
                        ...
                        <style jsx>{`
                          .total-score-value { font-size: 1.8rem; font-weight: 800; color: #000; }
                        `}</style>
                      </div>
                    </div>
                  </div>
      ...
      <style jsx global>{`
        /* Весь твой остальной CSS остается без изменений */
