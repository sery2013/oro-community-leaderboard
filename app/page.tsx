...
export default function Leaderboard() {
  ...
  return (
    <div className="container">
      ...
      {/* ФИНАЛЬНЫЕ СТИЛИ НА БАЗЕ ТВОЕГО ФОНА */}
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .search-icon {
          position: absolute; left: 20px; top: 50%; transform: translateY(-50%); opacity: 0.6;
        }
        ...
        .stat-label { display: block; font-size: 0.65rem; font-weight: 800; text-transform: uppercase; opacity: 0.5; }
        ...
        .rank-number { font-size: 2.5rem; font-weight: 900; }
        .avatar-wrapper { position: relative; }
        .user-avatar { width: 70px; height: 70px; border-radius: 20px; border: 2.5px solid #000; }
        .display-name { font-size: 1.4rem; font-weight: 800; margin: 0; }
        ...
        .total-score-value { font-size: 2.4rem; font-weight: 900; line-height: 1; }

        .positive { color: #006b1b; font-weight: 700; }
        .negative { color: #9e0000; font-weight: 700; }
        ...
        .download-btn {
          ...
          font-weight: 900; cursor: pointer; margin-top: 25px;
        }

        @media (max-width: 1100px) {
          .contributor-card { flex-direction: column; }
          .card-identity { border-right: none; border-bottom: 1px solid rgba(0,0,0,0.1); min-width: auto; }
          .metrics-inner { grid-template-columns: 1fr 1fr; }
          .metric-box.total { grid-column: span 2; }
        }
      `}} />
    </div>
  );
